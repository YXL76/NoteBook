...
| 泊松分布  | $X\sim\pi(\lambda)$ |                $P(X=k)=\frac{\lambda^ke^{-\lambda}}{k!}$                 | $\lambda$ | $\lambda$ |

- 连续型

|   分布   |          记号           |                                                    概率密度函数                                                     |      期望       |         方差         |
| :------: | :---------------------: | :-----------------------------------------------------------------------------------------------------------------: | :-------------: | :------------------: |
| 均匀分布 |     $X\sim U(a,b)$      |             $f(x) = \left\{ \begin{array}{ll} \frac{1}{b-a}, & a<x<b \\ 0, & other \end{array} \right.$             | $\frac{a+b}{2}$ | $\frac{(b-a)^2}{12}$ |
